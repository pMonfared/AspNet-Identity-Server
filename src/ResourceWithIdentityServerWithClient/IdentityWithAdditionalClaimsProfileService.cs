...
namespace ResourceWithIdentityServerWithClient
{
    ...
    {
        private readonly IApplicationUserClaimsPrincipalFactory _claimsFactory;
        private readonly IApplicationUserManager _userManager;

        public IdentityWithAdditionalClaimsProfileService(IApplicationUserManager userManager, IApplicationUserClaimsPrincipalFactory claimsFactory)
        {
        ...
        public async Task GetProfileDataAsync(ProfileDataRequestContext context)
        {
            ...
            {
                claims.Add(new Claim(JwtClaimTypes.Role, item.Role.Name));
            }
